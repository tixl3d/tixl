...
internal static class UiRegistration
{
    public static void RegisterUiTypes()
    {
        ...
        RegisterTypesToProperty(UiProperties.Shader,
                                ...
                                // sharpDX types
                                typeof(T3.Graphics.Compat.BindFlags),
                                typeof(T3.Graphics.Compat.BlendOperation),
                                typeof(T3.Graphics.Compat.BlendOption),
                                typeof(T3.Graphics.Compat.BlendState),
                                typeof(T3.Graphics.Compat.Buffer),
                                typeof(T3.Graphics.Compat.ColorWriteMaskFlags),
                                typeof(T3.Graphics.Compat.Comparison),
                                typeof(T3.Graphics.Compat.CpuAccessFlags),
                                typeof(T3.Graphics.Compat.CullMode),
                                typeof(T3.Graphics.Compat.DepthStencilState),
                                typeof(T3.Graphics.Compat.DepthStencilView),
                                typeof(T3.Graphics.Compat.FillMode),
                                typeof(T3.Graphics.Compat.Filter),
                                typeof(T3.Graphics.Compat.InputLayout),
                                typeof(T3.Graphics.Compat.RasterizerState),
                                typeof(T3.Graphics.Compat.ResourceOptionFlags),
                                typeof(T3.Graphics.Compat.ResourceUsage),
                                typeof(T3.Graphics.Compat.SamplerState),
                                typeof(T3.Graphics.Compat.TextureAddressMode),
                                typeof(T3.Graphics.Compat.UnorderedAccessViewBufferFlags),
                                typeof(T3.Graphics.Format),
                                typeof(T3.Graphics.Viewport),
                                typeof(T3.Graphics.ScissorRect),
                                typeof(T3.Graphics.Compat.RenderTargetBlendDescription),
                                // sharpDX types
                                typeof(T3.Graphics.Compat.DepthStencilView),
                                typeof(T3.Graphics.Compat.RenderTargetView),
                                typeof(T3.Graphics.Compat.ShaderResourceView),
                                typeof(T3.Graphics.Compat.UnorderedAccessView)                                
                               );
        ...
        RegisterTypesToProperty(UiProperties.GpuData,
                                ...
                                // sharpDX types
                                typeof(T3.Graphics.Compat.PrimitiveTopology));
