...
2. Reroutes support manual movement and normal socket connections. Magnetic block snapping, automatic insertion by dragging a node onto a wire, automatic anchor merging, and preserve-wires dissolve are outside this first implementation. Automatic tree layout preserves manually placed anchors as obstacles.
...
- Reroutes deliberately do not participate in block snapping, automatic splice/dissolve, or implicit merging with existing anchors. Ordinary editor bypass requests leave them unchanged; direct external manipulation of Core bypass state is outside this UI feature.
