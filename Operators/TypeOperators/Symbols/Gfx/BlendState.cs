...
public sealed class BlendState : Instance<BlendState>
{
    ...
    public readonly Slot<T3.Graphics.Compat.BlendState> Value = new();
    ...
    private void Update(EvaluationContext context)
    {
        ...
        try
        {
            Value.Value = new T3.Graphics.Compat.BlendState(ResourceManager.Device, blendDesc); // todo: put into resource manager
        }
        catch (Exception e)
        {
    ...
    private List<Slot<T3.Graphics.Compat.RenderTargetBlendDescription>> _connectedDescriptions = [];

    [Input(Guid = "63D0E4E8-FA00-4059-A11B-6A31E66757DC")]
    public readonly MultiInputSlot<T3.Graphics.Compat.RenderTargetBlendDescription> RenderTargets = new();
