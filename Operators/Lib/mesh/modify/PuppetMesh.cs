...
internal sealed class PuppetMesh :Instance<PuppetMesh>
{
    ...
    public readonly Slot<MeshBuffers> Result = new();
        ...
        [Input(Guid = "bb507680-a293-4c2b-9e73-a9f96bd395bf")]
        ...
        public readonly InputSlot<T3.Core.DataTypes.BufferWithViews> ControlPoints = new InputSlot<T3.Core.DataTypes.BufferWithViews>();
        ...
        [Input(Guid = "e45eddd4-8a70-400d-9747-a3f35a0f928b")]
        public readonly InputSlot<bool> GlobalInfluence = new InputSlot<bool>();
