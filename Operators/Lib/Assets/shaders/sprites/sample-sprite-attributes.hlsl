...
StructuredBuffer<SpriteDef> InputSprites : register(t1);
RWStructuredBuffer<SpriteDef> ResultSprites : register(u0);    // output1
//RWStructuredBuffer<SpriteDef> ResultSprites : register(u0);     // output2
