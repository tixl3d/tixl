...
* Use screen capture tools like [OBS](https://obsproject.com/), [Windows+G Game Bar](https://www.microsoft.com/en-us/windows/learning-center/how-to-record-screen-windows-11), or [ScreenToGif](https://www.screentogif.com/) to record a short video and paste it into your report.
...
* [Search all issues](https://github.com/tixl3d/tixl/issues?q=is%3Aissue%20) to see if someone else already reported something similar.
* [Install the newest release](https://github.com/tixl3d/tixl/releases) to check if the problem still exists.


## Where to Report

Ideally, [create a new GitHub issue](https://github.com/tixl3d/tixl/issues/new/choose) and paste all your information there. We monitor the list and respond to all reports.

For minor issues — or if you're unsure whether *“it's just you”* — you can also ask in the **#questions-and-feedback** channel on [Discord](https://discord.gg/uC4hRRdp). Friendly people there will help you out.
...
As usual, the **#questions-and-feedback** channel on [Discord](https://discord.gg/uC4hRRdp) is a good starting point. But you should also consider submitting a [feature request on GitHub](https://github.com/tixl3d/tixl/issues/new/choose).
