...
This page assumes that [you're running TiXL from an IDE](help.InstallDev).
...
* It’s a good idea to always [use git](dev.WorkingWithGit) and commit or discard local changes.

## How can I create a new op?

* We recommend [duplicating an existing op](help.CreatingNewOps#3-duplicate-an-existing-operator).
